...
const stories = storiesOf('organisms/Cards', module);
...
stories.add('LuckyDrawCard', () => {
  return (
    <LuckyDrawCard
      ...
      imageUrl={text('imageUrl', 'https://d15jp4iwerkqw1.cloudfront.net/images/event/lucky/cf0f4bd3da6d443db222adff9e1fc842.png')}
