...
export default function CommonHead({
  ...
  return (
    <Head>
      ...
      {/* ============================================================ */}
      <link rel="icon" type="image/png" href="/public/guhada.ico" />
      {/* IE */}
      <link rel="shortcut icon" href="/public/guhada.ico" />
      {/* Windows 8  */}
      <meta name="msapplication-TileImage" content="/public/guhada.ico" />
      {/* Windows 8  */}
      ...
      <link
        ...
        sizes="144x144"
        href="/public/appicon/guhada-icon-144.png"
      />
      {/* iPhone Retina --> */}
      <link
        rel="apple-touch-icon-precomposed"
        sizes="114x114"
        href="/public/appicon/guhada-icon-57.png"
      />
      {/*  iPad 1 e 2 --> */}
      <link
        rel="apple-touch-icon-precomposed"
        sizes="72x72"
        href="/public/appicon/guhada-icon-72.png"
      />
