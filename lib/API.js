...
class ApiFactory {
  ...
  createInstance() {
    ...
    this.axios.interceptors.request.use(
      async config => {
        console.log(
          '[axios.interceptors.request] config.method',
          config.method
        );
        console.log('[axios.interceptors.request] config.url', config.url);
        console.log('[axios.interceptors.request] config.data', config.data);
