...
class ApiFactory {
  ...
  saveAuthTokens({ accessToken, expiresIn, refreshToken }) {
    const hostname = [
      ['dev.guhada.com', 'dev.m.guhada.com', 'dev.seller-admin.guhada.com'],
      ['qa.guhada.com', 'qa.m.guhada.com', 'qa.seller-admin.guhada.com'],
      ['stg.guhada.com', 'stg.m.guhada.com', 'stg.seller-admin.guhada.com'],
      ['web.guhada.com', 'm.guhada.com', 'seller-admin.guhada.com'],
      ['localhost', 'localhost', 'localhost'],
    ];

    hostname.map(hostItem => {
      if (hostItem[1] === 'localhost') {
      ...
      } else if (hostItem[1] === window.location.hostname) {
        hostItem.map(host => {
          console.log(host);
          Cookies.set(key.ACCESS_TOKEN, accessToken, {
            expires: moment()
  ...
  removeAccessToken() {
    const hostname = [
      'dev.guhada.com',
      'dev.m.guhada.com',
      'dev.seller-admin.guhada.com',
      'qa.guhada.com',
      'qa.m.guhada.com',
      'qa.seller-admin.guhada.com',
      'stg.guhada.com',
      'stg.m.guhada.com',
      'stg.seller-admin.guhada.com',
      'web.guhada.com',
      'm.guhada.com',
      'seller-admin.guhada.com',
    ];
    Cookies.remove(key.ACCESS_TOKEN);
    Cookies.remove(key.REFRESH_TOKEN);
    hostname.map(host => {
      return (
        Cookies.remove(key.ACCESS_TOKEN, { domain: host }),
        Cookies.remove(key.REFRESH_TOKEN, { domain: host })
      );
    });
