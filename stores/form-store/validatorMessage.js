module.exports = {
  ...
  'between.nickname': '닉네임은 3자 이상 15자 이하 입력하셔야 합니다.',
  ...
  'regex.nickname': '특수문자는 언더바(_)만 사용 가능합니다.',
  required: ':attribute 필드는 필수입니다.',
  'required.email': '아이디로 사용할 이메일을 입력하세요.',
  'required.password': '비밀번호를 입력하세요.',
  'required.passwordConfirm': '비밀번호를 한번 더 입력하세요.',
  'required.name': '이름을 입력하세요.',
  'required.detailAddress': '상세주소를 입력하세요.',
  'required.managerName': '담당자 이름을 입력하세요.',
  'required.managerEmail': '이메일을 입력하세요.',
  'required.managerMobile': '휴대폰 번호를 입력하세요.',
  'required.calculationReceivingMethod': '정산대금 수신 방법을 선택하세요.',
  'required.accountNumber': '은행 및 계좌번호 정보를 입력하세요.',
  'required.accountHolder': '예금주명을 입력하세요.',
  'required.departureName': '출고지명을 입력하세요.',
  'required.departureTelephone': '출고지 전화번호를 입력하세요.',
  // 'required.departureAddressView': '출고지 주소를 입력하세요.',
  'required.departureDetailAddress': '상세주소를 입력하세요.',
  'required.returnName': '반품/교환지명을 입력하세요.',
  'required.returnTelephone': '반품/교환지 전화번호를 입력하세요.',
  'required.returnDetailAddress': '상세주소를 입력하세요.',
  'required.claimTelephone': '고객응대 대표번호를 입력하세요.',
  'required.companyName': '상호명을 입력하세요.',
  'required.representativeName': '대표자명을 입력하세요.',
  'required.businessType': '업태를 입력하세요.',
  'required.businessItem': '종목을 입력하세요.',
  'required.businessDivision': '사업자 구분을 선택하세요.',
  'required.mailorderBusiness': '통신판매업 정보를 선택하세요.',
  'required.notReportingTypeSelect': '미신고 사유를 입력하세요.',
  'required.nickname': '닉네임을 입력하세요.',
  ...
  'same.passwordConfirm': '비밀번호가 일치하지 않습니다.',
  size: {
